...
The system processes the query, extracts potential store and city names, and performs flexible matching against the JSON data — even if the text is misspelled or formatted incorrectly.
